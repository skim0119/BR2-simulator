...
from br2.rod.cosserat_rod import (
...
class MemoryBlockMuscularRod(FreeCosseratRod, _RodSymplecticStepperMixin):
    ...
    Thus each system is now in contiguous memory, so it is faster to compute Muscular rod equations.
    ...
    def allocate_block_variables_in_elements(self, systems: Sequence):
        ...
        map_scalar_dofs_in_rod_elems = {
            ...
            "alpha_angle": 8,
            "beta_angle": 9,
            "initial_alpha_angle": 10,
            "initial_beta_angle": 11,
            "delta_turn": 12,
            "alpha_fiber_length": 13,
            "beta_fiber_length": 14,
            "initial_alpha_fiber_length": 15,
            "initial_beta_fiber_length": 16,
        }
