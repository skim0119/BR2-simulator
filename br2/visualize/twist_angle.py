    ...
    **kwargs,
    ...
    if kwargs.get("vis2D", True):
        ...
        for rod_idx in range(n_visualized_rods):
            ...
            normal_cal_degrees = normal[np.newaxis,:,:]#change to 3 dimension so compute_twist can calculate it
        ...
        ax.set_aspect("equal")
        video_name_2D = os.path.join(save_folder, video_name + "_2D_visual_twist_angle.mp4")
