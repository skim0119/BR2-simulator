...
# Package meta-data.
NAME = "br2"
DESCRIPTION = "BR2 soft-arm assembly simulator"
URL = "https://github.com/skim0119/BR2-simulator"
...
REQUIRED = ["pyelastica>=0.2.2.post2", "matplotlib>=3.3.2", "numpy", "tqdm"]
...
setup(
    ...
    download_url=f"https://github.com/skim0119/BR2-simulator/archive/refs/tags/v{VERSION}.tar.gz",
